...
public class WrappedEnumDifficulty extends WrappedType {
    ...
    static {
        ...
        for (Object e : EnumDifficulty.getEnumConstants())
            switch (((Enum) e).name()) {
                case "HARD":
                    HARD = getWrappedEnumDifficulty(e, "HARD");
                    break;
                case "NORMAL":
                    NORMAL = getWrappedEnumDifficulty(e, "NORMAL");
                    break;
                case "EASY":
                    EASY = getWrappedEnumDifficulty(e, "EASY");
                    break;
                case "PEACEFUL":
                    PEACEFUL = getWrappedEnumDifficulty(e, "PEACEFUL");
                    break;
            }
